...
function StranBody(fobj,BodyIsFt)
{
...
if(BodyIsFt=="1"){setTimeout("StranBody('',BodyIsFt)",StranIt_Delay)}

var StranLink_Obj=document.getElementById("GB2312")
if (StranLink_Obj)
{
	with(StranLink_Obj)
	{
		...
		{
			href="#";
			onclick= new Function("BodyIsFt=BodyIsFt==1?0:1;StranBody('',BodyIsFt);setCookie(JF_cn,BodyIsFt,7);return false")
		}
